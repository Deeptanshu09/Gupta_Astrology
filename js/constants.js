...
const PLANET_SK = ['Surya','Chandra','Mangala','Budha','Guru','Shukra','Shani','Rahu','Ketu'];
...
// FIX: index = sign (0=Aries..11=Pisces), value = ruling planet index into PLANETS[]
...
// FIX: Vimshottari lord cycle repeats every 9 nakshatras starting at Ashwini=Ketu.
// Index into DASHA_LORDS_VIM below (Ketu,Venus,Sun,Moon,Mars,Rahu,Jupiter,Saturn,Mercury = 0..8)
const NAK_LORDS_VIM = [0,1,2,3,4,5,6,7,8, 0,1,2,3,4,5,6,7,8, 0,1,2,3,4,5,6,7,8];
...
// House significations (index 0 = House 1)
const HOUSE_SIGNIFICATIONS = [
    'Self, personality, appearance','Wealth, speech, family','Siblings, courage, short travels',
    'Mother, home, happiness','Children, intelligence, creativity','Health, enemies, service, debts',
    'Spouse, partnerships, business','Longevity, transformation, occult','Luck, dharma, higher learning',
    'Career, reputation, father','Gains, income, elder siblings','Losses, foreign lands, liberation'
];
